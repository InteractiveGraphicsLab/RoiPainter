...
## 概要
RoiPainter3D/4Dは，X線CTやMRI装置で撮影された3/4次元グレースケール画像を観察・領域分割するためのソフトウエアです． 
...
* RoiPainter4Dは[こちら](RoiPainter4D_README.md)
* RoiPainter3Dは[こちら]()

## 開発者
井尻 敬 / Takashi Ijiri [web page](https://takashiijiri.com/){:target="_blank"}
