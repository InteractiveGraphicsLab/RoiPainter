...
独自形式 traw3d_ss ファイル出力された3次元画像を，複数指定します．このファイルはピッチ情報を持ち，一つの画素をsigned short（16bit）として保持します．データフォーマットの詳細については[こちら](https://www2.riken.jp/brict/Ijiri/flowerctlib/index.html)を参照してください．
