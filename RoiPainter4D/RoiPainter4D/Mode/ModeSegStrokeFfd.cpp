  ...
  const EVec3f& cam_cnt)
{
  ...
  else if (mode == SFFD_CAGE)
  {
    ...
    if (IsShiftKeyOn())
    {
      DrawCageWithCPs(cage, true, m_cp_size, m_meshseq.GetSelectedCageVtxVec());
    }
