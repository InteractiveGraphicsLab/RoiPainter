...
namespace RoiPainter4D {
	...
	/// FormFixMask の概要
	/// </summary>
	public ref class FormFixMask : public System::Windows::Forms::Form
	{
  private:
    static FormFixMask^ m_singleton;
    FormFixMask(void)
    {
      InitializeComponent();
    }
  ...
  public: 
    static FormFixMask^ GetInst()
    {
      if (m_singleton == nullptr) {
        m_singleton = gcnew FormFixMask();
      }
      return m_singleton;
    }
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->m_btn_convert_mask_mesh->Click += gcnew System::EventHandler(this, &FormFixMask::m_btn_convert_mask_mesh_Click);
			// 
			// m_btn_deform
			// 
			...
			this->m_btn_deform->Click += gcnew System::EventHandler(this, &FormFixMask::m_btn_deform_Click);
			// 
			// m_btn_undo
			// 
			...
			this->m_btn_undo->Click += gcnew System::EventHandler(this, &FormFixMask::m_btn_undo_Click);
			// 
			// m_btn_redo
			// 
			...
			this->m_btn_redo->Click += gcnew System::EventHandler(this, &FormFixMask::m_btn_redo_Click);
			// 
			...
			this->m_copy_from_prev_frame->Click += gcnew System::EventHandler(this, &FormFixMask::m_copy_from_prev_frame_Click);
			// 
			...
			this->m_btn_copy_stroke_all_frame->Click += gcnew System::EventHandler(this, &FormFixMask::m_btn_copy_stroke_all_frame_Click);
			// 
			// m_numbox_cpsize
			// 
			...
			this->m_numbox_cpsize->ValueChanged += gcnew System::EventHandler(this, &FormFixMask::m_numbox_cpsize_ValueChanged);
			// 
			// label4
			// 
			...
			this->m_checkbox_showonlyselectedstroke->CheckedChanged += gcnew System::EventHandler(this, &FormFixMask::m_checkbox_showonlyselectedstroke_CheckedChanged);
			// 
			...
			this->m_btn_convert_mesh_mask->Click += gcnew System::EventHandler(this, &FormFixMask::m_btn_convert_mesh_mask_Click);
			// 
			// m_trackbar_mcscale
			// 
			...
			this->m_btn_reload_mesh->Click += gcnew System::EventHandler(this, &FormFixMask::m_btn_reload_mesh_Click);
			// 
			// m_btn_sharestroke
			// 
			...
			this->m_btn_sharestroke->Click += gcnew System::EventHandler(this, &FormFixMask::m_btn_sharestroke_Click);
			// 
			// m_btn_loadstate
			// 
			...
			this->m_btn_loadstate->Click += gcnew System::EventHandler(this, &FormFixMask::m_btn_loadstate_Click);
			// 
			// m_btn_savestate
			// 
			...
			this->m_btn_savestate->Click += gcnew System::EventHandler(this, &FormFixMask::m_btn_savestate_Click);
			// 
			// FormFixMask
			// 
			...
			this->Name = L"FormFixMask";
			this->Text = L"FormFixMask";
